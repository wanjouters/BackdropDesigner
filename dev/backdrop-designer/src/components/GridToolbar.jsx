        ...
        <VSection label="Stijl">
          <label className="flex flex-col gap-0.5">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-[11px] font-mono text-gray-500">{format.BackgroundColor_Hex || '#000000'}</span>
            </div>
          </label>
        ...
        <Group label="Stijl">
          <label className="flex flex-col gap-0.5">
            ...
            <div className="flex items-center gap-1">
              ...
              />
              <span className="text-[10px] font-mono text-gray-500">{format.BackgroundColor_Hex || '#000000'}</span>
            </div>
          </label>
          <SelectInput label="Leeg slot" value={format.PlaceEmpty || 'blank'} options={PLACE_EMPTY_OPTIONS}
